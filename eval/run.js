...
// Exported so the test suite can pin the drafts-exclusion contract functionally (drafts-*.jsonl
// must never ride along in a run). See test/golden-drafts-exclusion.test.js.
